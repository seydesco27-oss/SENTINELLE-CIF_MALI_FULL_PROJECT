...
STRUCTURING_MIN_RATIO = 0.75   # avant : 0.90 - trop nettement separe du normal
STRUCTURING_MAX_RATIO = 0.99

# proportion de transactions LEGITIMES (non a risque) qui approchent aussi
# le seuil (gros decaissements de credit, depots d'affaires...) - sans ca,
# "etre proche du seuil" devient un raccourci trop parfait pour le modele
TAUX_TRANSACTIONS_LEGITIMES_ELEVEES = 0.015
