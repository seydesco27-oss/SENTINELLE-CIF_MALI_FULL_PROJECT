"""
train_model.py - Entraînement robuste d'un modèle de classification pour
les transactions synthétiques du niveau 3.

Utilise validation croisée par client, SMOTE, et test sur un holdout
de clients jamais vus à l'entraînement (sans fuite de données).
"""
...
def train_model_with_kfold():
    ...
    print("=" * 78)
    print("DISTRIBUTION DES CLASSES (split par CLIENT, sans fuite)")
    print("=" * 78)
